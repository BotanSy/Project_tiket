        ...
        <div class="container">
            <div class="row">
                ...
                <div class="main-content" style="padding: 10px;">
                    <h2 class="text-center mb-4" style="color: white;">Transaction</h2>
                      ...
                      <tbody>
                          <?php while ($order = mysqli_fetch_assoc($result)) { ?>
                              <tr>
                                  ...
                                  <td><?php echo $order['destination_id']; // Anda bisa mengganti dengan nama tujuan jika ada ?></td>
                                  <td><?php echo $order['departure_day']; ?></td>
